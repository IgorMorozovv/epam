...
public class LoggingMessages {
    ...
    public final static String _MESSAGE = "";
    public final static String START_MESSAGE = "Начало выполенения теста ";
    public final static String END_MESSAGE = "Конец выполнения теста ";
